...
extension to classical structured programming that interacts continuously with 
the environment.
%
...
to stack-living locals.
This memory model does not require a free primitive or garbage collection in 
the language, and also eliminates memory leaks by design.
\end{abstract}
...
containers to hold dynamic organisms instances.
%
