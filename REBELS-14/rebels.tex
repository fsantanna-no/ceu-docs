...
\code{dt} fields, corresponding to the LED I/O pin and blinking period, 
respectively.
...
%
The example of Figure~\ref{lst.unit} only illustrates events, as variables and 
methods work in the same way as in object oriented programming.
%
The class \code{Unit} (lines 1-16) defines the event \code{move} (line 2) that 
exposes requests to move the unit position.
%
...
\CEU also supports dynamic instances of organisms
spawn
