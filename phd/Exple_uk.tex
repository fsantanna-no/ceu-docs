...
\city{Rio de Janeiro}
\CDD{004}
\department{Departamento de Inform\'atica}
\program{Programa de P\'os-Gradua\c{c}\~ao em Inform\'atica}
...
\jury {
    ...
    \jurymember{Markus Endler}
                {Departamento de Inform\'{a}tica --- PUC-Rio}
    \jurymember{Silvana Rossetto}
                {UFRJ}
...
\resume {
He completed his undergraduate studies in Computer Engeneering at the
the Pontifical Catholic University of Rio de Janeiro (PUC--Rio) in 2003.
He received his Master degree in Computer Science from PUC--Rio in 2009.
}
...
\acknowledgment{
I would like to thank Roberto and Noemi for giving me freedom to make hits 
and misses for the last six years.
Also, Phillippas and Olaf for kindly receiving me in Chalmers, Sweden.
Luiz Fernando and Cerqueira for my period in the Telem\'idia Lab, where I 
started as a researcher.
Finally, all my teachers in CAp-UERJ, responsible for my education before 
college.
...
\chaves {
    \chave{Concorr\^encia}
    \chave{Determinismo}
    \chave{Sistemas Embarcados}
    \chave{Esterel}
    \chave{S\'incrono}
    \chave{Reativo}
    \chave{Redes de Sensores sem Fio}
}
%\end{comment}
